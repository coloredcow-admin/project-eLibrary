...
<body class="h-100 w-100 m-0 p-0" style="overflow-x:hidden;">
	<button onclick="topFunction()" class='btn btn-outline-dark position-fixed' style="display:none;bottom:80px; right:22px; z-index: 9999999;" id="top" title="Go to top"><i class="fa fa-arrow-alt-circle-up h5 pt-1 m-0"></i></button>
	<?php  
