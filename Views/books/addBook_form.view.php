          ...
          <div class="modal-content">
            ...
            <div class="modal-body">
              <div class="form-group">
                <input type="text" class="form-control" id="book_name" name="book_name" placeholder="Enter Book Name *"  value="<?=$book_name?>" onkeyup="checkFieldName('book_name')">
                <small class="form-text text-muted text-danger" id='errorbook_name'><?=$msg1?></small>   
              </div>
              <div class="form-group row">
               <div class="col mr-0 pr-0">
                 <input type="text" class="form-control" id="author_name" name="author_name" placeholder="Enter Author Name *" value="<?=$author_name?>" onkeyup="checkFieldName('author_name')">
                 <small class="form-text text-muted text-danger" id='errorauthor_name'><?=$msg2?></small>  
               </div>
               <div class="col ml-0 pl-0">
                 <input type="text" class="form-control" id="book_edition" name="book_edition" placeholder="Enter Book Edition *" value="<?=$book_edition?>" onkeyup="checkFieldName('book_edition')">
